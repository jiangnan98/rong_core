package com.rong.methods.group.ban.whitelist;
...
import com.rong.models.response.GroupBanWhitelistResult;
...
public class User {
    ...
    private static final String PATH = "group/mute/whitelist";
