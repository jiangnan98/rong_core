package com.rong.models.message;

import com.rong.messages.BaseMessage;
...
public class GroupMessage extends MessageModel {
     ...
     *
     * */
    public GroupMessage(String senderId, String[] targetId,String[] toUserId, String objectName, BaseMessage content, String pushContent, String pushData, Integer isIncludeSender, Integer isPersisted, Integer isCounted, Integer contentAvailable) {
        super(senderId, targetId, objectName, content, pushContent, pushData);
        this.isIncludeSender = isIncludeSender;
        this.isPersisted = isPersisted;
        //this.isCounted = isCounted;
